...
def load_data():
    with open('../data/scrape_data/20171026_den_tax_scrape/prop_title.txt', 'r') as f:
        data = []
...
def load_pins_to_schednum():
    df = pd.read_csv('../data/denver_open_data/20171015_residential_characteristics.csv', dtype='object')
    df = df[['PIN', 'SCHEDNUM']]
